...
#define DTC_RPI_MODEL_3CM		DTC_BOARD_MAKE_BRCM "," DTC_BOARD_MODEL_3CM
#define DTC_RPI_MODEL_3BP		DTC_BOARD_MAKE_BRCM "," DTC_BOARD_MODEL_3BP
#define DTC_RPI_MODEL_3AP		DTC_BOARD_MAKE_BRCM "," DTC_BOARD_MODEL_3AP
#define DTC_RPI_MODEL_3B		DTC_BOARD_MAKE_BRCM "," DTC_BOARD_MODEL_3B
#define DTC_RPI_MODEL_ZERO_2W	DTC_BOARD_MAKE_BRCM "," DTC_BOARD_MODEL_ZERO_2W
